...
app = FastAPI(title="URL Shortener API (HA)", version="1.0.0")
...
create_rate_limiter = RedisRateLimiter(
    redis_client, settings.rate_limit_create_per_minute, key_prefix="ratelimit:create"
)
redirect_rate_limiter = RedisRateLimiter(
    redis_client, settings.rate_limit_redirect_per_minute, key_prefix="ratelimit:redirect"
)
